    ...
    return (
      <SelectDropdown
        ...
        renderCustomizedRowChild={item => {
         const itemName=(item.match(/\w+/gi))
         // this cause the item itselfe from server has wierd spaces in so i just remove them 
          return (
           
            <Text style={{fontFamily: 'Cairo-Bold', color: 'gray',marginHorizontal:10}}>
              {itemName[0]}
         </Text> 
          );
        }}
  ...
  function check(done) {
    ...
    if (
      ...
      Alert.alert(
        ...
        [
          {
            onPress:()=>{console.log(navigation.navigate('drawer'));},
            text: "done",
          },
        ],
